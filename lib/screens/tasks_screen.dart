  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 9, 141, 207),
        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              ...
              accountName: Text("Halifax"),
              accountEmail: Text("halifaxhali77@gmail.com"),
            ),
      ...
      backgroundColor: Color.fromARGB(255, 212, 217, 217),
    );
  }
}